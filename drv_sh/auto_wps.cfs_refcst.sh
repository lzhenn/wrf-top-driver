...
echo "Working on WPS->Ungrib CFS_RFCT-pl..."
ln -sf ungrib/Variable_Tables/Vtable.CFSR Vtable
./link_grib.csh $DRVDIR/pgbf*.grb2
sed -i "/prefix/s/^.*/ prefix = 'CFSPL',/g" namelist.wps
./ungrib.exe >& $LOGFILE
# Process CFSv2 single layer
./link_grib.csh $DRVDIR/flxf*.grb2
## Modify to CFS single layer
echo "Working on WPS->Ungrib CFS_RFCT-sl..."
